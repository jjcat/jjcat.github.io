...
[![](http://i.imgur.com/0Qc0M.png) {: .imgshadow} ](http://i.imgur.com/0Qc0M.png) 
<small class="muted">默认的Inspector和自定义Inspector的对比</small> {: .muted}
...
<small>一个Unity Reference中的窗口例子</small> {: .muted}
...
[![](http://i.imgur.com/TKAop.png)](http://i.imgur.com/TKAop.png) {: .imgshadow}
<small>Mono Develop Attach to Process...对话框</small> {: .muted}
>注意
